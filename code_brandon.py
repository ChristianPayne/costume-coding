...
while True:
    RunAnimation([
        (grow, chestPixels + baddieShoulderPixels),
        ], 60, 120, 10)
    RunAnimation([
        (random_color, chestPixels + baddieShoulderPixels),
        ], 60, 120, 10)
    RunAnimation([
        (solid_color, chestPixels + baddieShoulderPixels),
        (glitch, chestPixels + baddieShoulderPixels),
        ], 30, 300, 10)
    RunAnimation([
        (rainbow_cycle, chestPixels + baddieShoulderPixels),
        ], 30, 300, 10)
    RunAnimation([
        (heart_beat, chestPixels),
        ], 6, 12, 10)
